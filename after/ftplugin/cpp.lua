-- Google C++ Style: 2-space indentation, 80 columns
...
-- NOTE: only effective when treesitter indent is disabled for cpp.
-- To use cinoptions, add `cpp = true` to `indent_disabled` in treesitter.lua.
--
